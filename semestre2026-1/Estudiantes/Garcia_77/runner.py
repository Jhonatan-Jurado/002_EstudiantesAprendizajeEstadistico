...
_STUDENT_ROOT = Path("semestre2026-1/Estudiantes/Garcia_77")
...
def main():
    parser = argparse.ArgumentParser(
        description=(
            "Reproducible Data Observatory Runner — Garcia_77 | 2026-1\n"
            "Each lab writes to its own isolated folder under:\n"
            "  semestre2026-1/Estudiantes/Garcia_77/Laboratorios/{lab}/"
        ),
